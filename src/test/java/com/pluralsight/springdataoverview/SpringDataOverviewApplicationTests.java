...
public class SpringDataOverviewApplicationTests {
	...
	@Autowired
	private EntityManager entityManager; //is part of the JPA infrastructure. It’s responsible for managing entities (such as database records) within a persistence context.
